                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Cloud databases</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Website Hoisting</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>File Storage</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Forex Trading</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>File Backups</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Remote desktop</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Email Servers</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Hybrid Cloud</h6>
                                        </div>
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-lg-6'>
                            ...
                            <img src='homeimages/section-fullimg2.png' className='img1' alt='bulb'></img>
                            </div>
                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Responsive design</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>React web development</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Android apps development</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Laravel web development</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>iOS apps development</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>UX/UI design</h6>
                                        </div>
                                ...
                                <div className='col-lg-6 col-md-6 mb-4'>
                                    <div className='card border-0 shadow-sm'>
                                        <div className='d-flex align-items-center px-2 py-3'>
                                            ...
                                            <h6 className='m-0'>Print ready design</h6>
                                        </div>
